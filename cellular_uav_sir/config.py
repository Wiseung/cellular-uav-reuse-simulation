...
class SimulationConfig:
    ...
    handover_l3_filter_alpha: float = 0.6
    handover_time_to_trigger_steps: int = 2
    dynamic_min_dwell_steps: int = 3
    dynamic_outage_threshold_db: float = 0.0
    power_split_exponent: float = 1.0
    coordinated_scheduling_enabled: bool = True
    coordinated_scheduling_cluster_size: int = 2
    coordinated_scheduling_sinr_threshold_db: float = 5.0
    coordinated_scheduling_blank_fraction: float = 0.65
    gis_los_enabled: bool = True
    gis_excess_loss_enabled: bool = True
    gis_penetration_loss_per_meter_db: float = 0.35
    gis_penetration_loss_cap_db: float = 18.0
    gis_diffraction_loss_cap_db: float = 24.0
    gis_total_excess_loss_cap_db: float = 32.0
